        ...
        >
          <Box className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <Box className="space-y-4 md:space-y-6">
              <Box>
                <Label text="Tên đăng nhập" htmlFor="email" required={true} />
                <Input
                  type="text"
                  name="email"
                  id="email"
              ...
              <Box>
                <Label text="Mật khẩu" htmlFor="password" required={true} />
                <Input
                  ...
                  icon={
                    togglePassword
                      ? FileHelpers.getLocalFile("close-eye", "svg")
                      : FileHelpers.getLocalFile("open-eye", "svg")
                  }
                  iconPosition="right"
                  onIconClick={() => {
