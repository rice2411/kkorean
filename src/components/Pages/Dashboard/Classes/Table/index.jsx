...
import ClassModifierModal from "../Modal";
...
function TableClasses({ classes }) {
    ...
    const handleOpenModal = (type, data) => {
        handleModiferModalBlank({
            isOpen: true,
            title: type === MODAL_TYPE.CREATE ? "Thêm lớp" : "Chỉnh sửa lớp",
            type: type,
            defaultData: data,
        });
    };
    ...
    const handleDelete = (_class) => {
        handleModiferModalConfirm({
            isOpen: true,
            text: `Bạn có muốn xóa lớp <b>${_class.name}</b>`,
            okButton: {
                text: "Xác nhận",
                onClick: () => {
                    onDelete(_class);
