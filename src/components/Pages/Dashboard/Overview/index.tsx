        ...
        <>
            ...
            <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm  sm:p-6 ">
                    ...
                    <div className="items-center sm:flex">
                        <div className="flex items-center">
                            <button
                                ...
                                className="mb-4 sm:mb-0 mr-4 inline-flex items-center text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-4 py-2.5    :bg-gray-700 :border-gray-600 :ring-gray-700"
                                type="button"
                            >
                                Filter by status
                                <svg
                            ...
                            <div
                                ...
                                style={{
                                    ...
                                    margin: 0,
                                    transform: "translate(1098px, 3014px)",
                                }}
                            >
                                ...
                                >
                                    <li className="flex items-center">
                                        <input
                                            ...
                                            type="checkbox"
                                            defaultValue=""
                                            className="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 :ring-primary-600  focus:ring-2  "
                                        />
                                        <label
                                            htmlFor="apple"
                        ...
                        >
                            <div className="relative">
                                ...
                                <input
                                    name="start"
                                    type="text"
                                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5     :ring-primary-500 :border-primary-500 datepicker-input"
                                    placeholder="From"
                                />
                            </div>
                            <div className="relative">
                ...
                <div className="flex items-center justify-between pt-3 sm:pt-6">
                    <div>
                        <button
                            className="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900  :text-white"
                            type="button"
                        ...
                        <div
                            ...
                            style={{
                                ...
                                margin: 0,
                                transform: "translate(266px, 2731px)",
                            }}
                        ...
                        >
                            ...
                            <ul className="py-1" role="none">
                                <li>
                                    <a
                                        href="#"
                                        className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100  :bg-gray-600 :text-white"
                                        role="menuitem"
                                    >
                                        Yesterday
                                    </a>
                    ...
                    <div className="flex-shrink-0">
                        <a
                            href="#"
                            className="inline-flex items-center p-2 text-xs font-medium uppercase rounded-lg text-primary-700 sm:text-sm hover:bg-gray-100  :bg-gray-700"
                        >
                            Transactions Report
                            <svg
